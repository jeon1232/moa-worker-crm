...
-- WARNING: This deletes app data in public.customers, public.customer_documents,
-- public.profiles, and public.login_allowlist. It does not delete auth.users.
...
drop table if exists public.customer_delete_requests cascade;
drop table if exists public.customers cascade;
drop table if exists public.access_requests cascade;
drop table if exists public.login_allowlist cascade;
...
drop function if exists public.apply_allowed_profile();
